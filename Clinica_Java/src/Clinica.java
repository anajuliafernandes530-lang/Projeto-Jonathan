public class Clinica {
    ...
    public Clinica(int capacidadePacientes) {
        this.pacientes = new Paciente[capacidadePacientes];
    }

    public Clinica(int capPac, int capProf) {
        this.pacientes     = new Paciente[capPac];
        this.profissionais = new Profissional[capProf];
    }

    public Clinica(int capPac, int capProf, int capCons, int capPag) {
        this.pacientes     = new Paciente[capPac];
        this.profissionais = new Profissional[capProf];
        this.consultas     = new Consulta[capCons];
        this.pagamentos    = new Pagamento[capPag];
    }
    ...
    public Profissional buscarProfissionalDisponivel(String especialidade, String diaSemana, String hora) {
        int i = 0;
        while (i < qtdProfissionais) {
            ...
            if (p.especialidade.equalsIgnoreCase(especialidade)
                ...
                && !horarioOcupado(p.nome, diaToData(diaSemana), hora)) {
                return p;
            }
            i = i + 1;
        }
    ...
    public int paraNumero(String data) {
        ...
        return Integer.parseInt(aa+mm+dd);
    }
